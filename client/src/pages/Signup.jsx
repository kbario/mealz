...
function Signup() {
  ...
  useEffect(() => {
    setPageInView(
      localStorage.getItem('hereBefore') || '' ? 'login' : 'signup'
    );
  }, []);
  ...
  return (
    <Flex h="100%" w="100%" direction="column">
      <NavHeader />
      <Flex grow={1} w="100%" direction="column" p="5" align="center" justify="center" gap="10">
      {pageInView === 'login' && (
        ...
        <Flex direction="column" gap="5">
          ...
          <FormControl isInvalid={passwordConfirmError} isRequired>
            ...
            {passwordConfirmError ? (
              ...
              <FormHelperText>
                password must contain atleast one upper- and lowercase letters,
                number, and punctuation symbols
              </FormHelperText>
            )}
          </FormControl>
